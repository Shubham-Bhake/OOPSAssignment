	...
	void InitializePerson()
	   {
		System.out.println("----------Initializing Person using super in Customer -----------");
		   super.setPid(101);            System.out.println("Person Id      = "+super.getPid());
		   super.setPname("Ashwini");      System.out.println("Person Name    = "+super.getPname());
		   super.setPaddress("Barshi");  System.out.println("Person address = "+super.getPaddress());
		   super.setDob(1996);           System.out.println("Person DOB     = "+super.getDob());
	   }

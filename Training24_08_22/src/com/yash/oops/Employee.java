	...
	void InitializePerson()
	   {
		   ...
		   super.setPid(100);            System.out.println("Person Id      = "+super.getPid());
		   super.setPname("Priya");      System.out.println("Person Name    = "+super.getPname());
		   super.setPaddress("ANagar");  System.out.println("Person address = "+super.getPaddress());
		   super.setDob(1991);           System.out.println("Person DOB     = "+super.getDob());
	   }

package com.yash.oops.shapeAxis;
...
public class Square implements Shape {
	...
	public double area() {
		...
		// System.out.println(length=Math.sqrt(length1)); 
		...
		xb2=sc.nextInt(); 
		yb2=sc.nextInt(); 
		double breath1 =((xb1-xl1)*(xb1-xl1))+((yb1-yl1)*(yb1-yl1)); //System.out.println(breath=Math.sqrt(breath1)); 
		breath=Math.sqrt(breath1); System.out.println(length+" "+breath+" "); 

...
public class Test 
{
  public static void main(String[] args) 
  {
	  ...
	  Branch   b1 = new Branch(101,"ICICI","WARORA" );
	  System.out.println("------details of brnach b1---------------------");
	  System.out.println(b1);
	  
	  Branch   b2 = new Branch(102,"SBI","NAGPUR" );
	  System.out.println("------details of brnach b2-------------------");
	  System.out.println(b2);
	  
	  Branch   b3 = new Branch(103,"PNB","PUNE" );
	  System.out.println("------details of brnach b3--------------------");
	  System.out.println(b3);
	  
	System.out.println("=========customer details================");	
	
	Customer c1 = new Customer(101,301,"SHUBHAM", "JAVA","15/11/91","12/12/21", b1);
	System.out.println("=---details of customer c1---------------------------------------");
	System.out.println(c1);
	
	Customer c2 = new Customer(102,302,"RAM", "abd","07/07/91","01/12/22", b2);
	System.out.println("=---details of customer c2---------------------------------------------");
	System.out.println(c2);
	
	Customer c3 = new Customer(103,30002,"VISHRUT", "CCNA","05/03/95","01/02/20", b3);
